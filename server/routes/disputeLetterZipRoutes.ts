...
export async function sendForPrinting(req: AuthRequest, res: Response) {
  try {
    ...
    <head>
      ...
      <title>Print Request - Score Machine Elite</title>
      <!--[if mso]>
      <style type="text/css">
            ...
            <table role="presentation" width="680" cellpadding="0" cellspacing="0" border="0" style="max-width:680px;width:100%;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.1);">
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td align="center" valign="middle" style="padding-right:16px;">
                        <img src="cid:company-logo" alt="Score Machine Elite" width="60" height="60" style="display:block;width:60px;height:60px;border-radius:12px;background-color:#ffffff;object-fit:contain;" />
                      </td>
                      <td align="left" valign="middle">
                        <div style="color:#ffffff;font-size:26px;font-weight:800;letter-spacing:-0.5px;line-height:1.2;">Score Machine Elite</div>
              ...
              <tr>
                <td align="center" style="background-color:#f8fafc;padding:32px 40px;border-top:1px solid #e2e8f0;">
                  <div style="font-size:16px;font-weight:700;color:#0c4a6e;margin-bottom:4px;">Score Machine Elite</div>
                  <div style="font-size:13px;color:#64748b;margin-bottom:16px;">Professional Credit Management Platform</div>
                  <div style="font-size:12px;color:#94a3b8;">&copy; ${new Date().getFullYear()} Score Machine Elite. All rights reserved.</div>
                </td>
              </tr>
            </table>
          </td>
    ...
    const emailSent = await emailService.sendEmail({
      ...
      subject: `Print Request — ${clientFullName} — ${letterCount} Dispute Letter${letterCount > 1 ? 's' : ''} | Score Machine Elite`,
      html: emailHtml,
