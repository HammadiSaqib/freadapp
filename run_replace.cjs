...
fs.writeFileSync('client/pages/AffiliateReferrals.tsx', beforeReturn + newReturn, 'utf8');
console.log('Successfully updated AffiliateReferrals.tsx');
