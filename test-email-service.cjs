...
async function testEmailService() {
  ...
  try {
    ...
    const testEmail = {
      from: `"${process.env.EMAIL_FROM_NAME || 'Fread App'}" <${process.env.EMAIL_FROM_ADDRESS || process.env.EMAIL_USER}>`,
      to: process.env.EMAIL_USER, // Send to self for testing
      subject: 'Test Email - Fread App Email Service',
      html: `
    ...
    const verificationEmail = {
      ...
      subject: 'Email Verification Code - Fread App',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #2563eb; margin: 0;">Fread App</h1>
          ...
          <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
            <p style="color: #9ca3af; font-size: 12px;">
              © 2024 Fread App. All rights reserved.
            </p>
          </div>
        </div>
      `,
