...
export default function CreditReadiness() {
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Credit Readiness Checklist & Insights | Fread App</title>
        <meta
          name="description"
          content="Review credit readiness with structured insights. Fread App helps organize credit data, highlight indicators, and export summaries to support responsible decision making. No outcomes are guaranteed."
        />
      ...
      <section className="py-16 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto mt-4">
              Answers to common questions about credit readiness and Fread App’s Toolkit.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>Does Fread App guarantee improvements or approvals?</CardTitle>
                <CardDescription>No promises or guarantees</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-700">
                  No. Fread App provides organizational insights and structured analysis of report data. We do not guarantee credit improvement, approvals, or specific outcomes. Decisions are made by lenders and depend on many factors.
                </p>
              </CardContent>
            </Card>
            <Card>
