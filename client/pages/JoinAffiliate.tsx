...
const JoinAffiliate: React.FC<JoinAffiliateProps> = ({
  ...
  return (
    <div className={embed ? 'min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/20 font-sans py-8' : 'min-h-screen bg-white'}>
      <Helmet>
        <title>{embed ? 'Affiliate Registration Embed - The Capsol' : 'Affiliate Program - The Capsol | Partner & Earn'}</title>
        <meta name="description" content="Join The Capsol’s Affiliate and Partner Programs. Earn recurring commissions by promoting a professional, AI-based credit analysis platform. Access training, analytics, tracking tools, and compliance-ready marketing resources." />
        {embed ? (
          <>
        ...
        <div className="relative container mx-auto px-4 py-24 lg:py-32">
          <div className="text-center max-w-6xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-ocean-blue/10 to-sea-green/10 backdrop-blur-sm border border-ocean-blue/20 rounded-full px-6 py-3 mb-8 shadow-lg">
              ...
              <span className="text-ocean-blue font-semibold">Earn with The Capsol</span>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Start free as an Affiliate, grow with Partner tiers, or build your own brand with <span className="font-semibold text-orange-600">White Label (Coming Soon)</span>—powered by The Capsol's comprehensive funding platform.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Four simple steps to start earning with The Capsol's comprehensive funding platform.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Complete the form to join our Affiliate or Partner network and start promoting The Capsol's industry-leading funding platform.
              </p>
            </div>
            ...
            <Card className="group relative border-0 shadow-0xl bg-white/90 backdrop-blur-sm hover:shadow-3xl transition-all duration-500 overflow-hidden">
              ...
              <CardHeader id="apply" className="pb-8 pt-12 relative">
                ...
                <CardDescription className="text-center text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                  Join thousands earning with The Capsol by promoting a comprehensive credit analysis platform with verified results.
                </CardDescription>
              </CardHeader>
