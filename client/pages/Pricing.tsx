...
export default function Pricing({ embed = false }: PricingProps) {
  ...
  return (
    <div className={rootClassName}>
      <Helmet>
        <title>{embed ? 'Pricing Embed - The Capsol' : 'Pricing Plans - The Capsol | Professional Credit Analysis Tools'}</title>
        <meta name="description" content="Explore transparent pricing for The Capsol’s AI-powered credit analysis tools. Access automated workflows, progress tracking, client dashboards, report summaries, and secure credit data organization. No credit improvement or funding outcomes are implied or guaranteed." />
        {embed ? (
          <>
      ...
      {!embed && (
       <div className="py-8 bg-gray-50 text-center px-4">
        <p className="text-xs text-gray-500 max-w-4xl mx-auto leading-relaxed">
          The Capsol provides tools for organizing and reviewing credit report information. It does not guarantee credit improvement, funding approval, or specific financial outcomes. All insights are for informational purposes only.
        </p>
       </div>
      )}
      {!embed && <Footer />}
