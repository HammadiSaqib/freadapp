...
import { PostCard, CommunityPost } from './community/PostCard';
...
export default function BasicCommunityFeed({ currentUser }: CommunityFeedProps) {
      ...
      <div className="min-h-screen dark:dark:">
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex items-center justify-center py-32">
            <div className="text-center bg-white   rounded-sm p-12">
  ...
  return (
    <div className="min-h-screen dark:dark:">
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        {stats && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <Card className="border border-slate-300 hover:transition-all duration-300 transform hover:-translate-y-1 rounded-sm from-white /50 dark:dark:">
        ...
        {/* Header */}
        <div className="bg-white   rounded-sm border border-slate-300 p-8">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <h2 className="text-4xl font-bold  text-slate-900">Community Feed</h2>
              {isPolling && (
                <Badge className="text-white border border-slate-300 rounded-sm px-4 py-2">
                  <div className="w-2 h-2 bg-white rounded-sm animate-pulse mr-2" />
                  Live Updates
                </Badge>
              )}
            </div>
            <Button
              ...
              className="border-2 border-blue-200 text-blue-600 hover:bg-blue-50 hover:text-blue hover:"
            >
      ...
      <div className="flex items-center justify-between mt-6">
        ...
        {hasMore && posts.length > 0 && (
          <div className="flex justify-center">
            <Button
              ...
              disabled={isLoading}
              className="border-2 border-blue-200 text-blue-600 hover:bg-blue-50 hover:border-blue-300 rounded-sm px-10 py-4 font-semibold transition-all duration-300 hover:transform hover:-translate-y-1"
            >
              {isLoading ? (
                <>
        ...
        {posts.length === 0 && (
          <Card className="bg-white   border border-slate-300 rounded-sm">
