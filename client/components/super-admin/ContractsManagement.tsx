...
const getHeading = (tab: ContractsTab) =>
  tab === "tsm-elite" ? "The Capsol Elite" : "Admin Contracts";

const getDescription = (tab: ContractsTab) =>
  tab === "tsm-elite"
    ? "Create and edit The Capsol Elite contract templates"
...
const getTableDescription = (tab: ContractsTab) =>
  tab === "tsm-elite"
    ? "Manage reusable The Capsol Elite contract templates"
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        <TabsList className="grid w-full max-w-md grid-cols-2">
          ...
          <TabsTrigger value="tsm-elite">The Capsol Elite</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value={activeTab} className="space-y-6 mt-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {activeTab === "tsm-elite"
                  ? "Search and filter The Capsol Elite templates"
